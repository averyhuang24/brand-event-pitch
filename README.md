...
- 支持用户只给主题时，先做小红书/抖音/公开网页的实时趋势研究，再提炼招商创意
- 支持从热点内容、选题会输入、爆款短视频/直播/综艺/海外内容/AI 玩法中提炼招商创意
...
```text
用 $brand-event-pitch，帮我想一组可招商的营销点子。
节点：七夕
目标品牌：美妆、珠宝、鲜花、本地生活
已有资源：达人短视频、直播间、搜索、H5、线下快闪
输出：给我 5 个方向，每个方向说明用户为什么参与、品牌怎么进入、可卖权益和风险。
```

如果希望点子结合当下爆火内容，可以这样说：

```text
用 $brand-event-pitch，围绕“七夕美妆服饰送礼”先做一轮小红书/抖音趋势研究，再帮我脑爆可招商的营销 idea。
要求：先说明你能用的平台搜索能力和来源信心，再给我 5 个方向，每个方向要有趋势依据、内容母题、线上线下玩法、品牌进入方式和可卖权益。
```
...
- 热点输入：如果要借鉴流行内容，请提供选题会记录、爆款案例、综艺/直播/短视频/海外内容/AI 玩法或节日趋势。
- 实时趋势需求：如果希望基于当下爆火内容脑爆，请说明主题、平台范围（小红书/抖音/全网）、目标人群、品类和节点；如果当前 agent 没有平台 MCP，最好补充链接、截图或选题会记录。
...
│   ├── content-trend-method.md
│   ├── live-trend-research.md
│   ├── pitch-method.md
│   ├── chrome-rules.md
│   ├── image-rules.md
...
- 点子必须能被招商：不只好玩，还要能拆出品牌角色、可售资源、交付物、席位和执行节奏。
- 每个点子都要回答四个问题：用户为什么参与、品牌为什么自然出现、平台资源如何放大、活动后留下什么资产。
- 优先从样本沉淀出的高频入口组合创意：内容/达人、互动/H5/AI、直播/搜索/货架、线下场景、PR/战报/IP 授权。
- 不把“品牌露出”“话题挑战”“达人种草”当点子本身；它们只是资源，要被包装成用户可感知的活动机制。
